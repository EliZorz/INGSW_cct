 ...
 */
public class StaffSelectedTripDbDetails implements Serializable {
    ...
    public StaffSelectedTripDbDetails(StaffSelectedTripGuiDetails childguiSp){
    ...
    public StaffSelectedTripDbDetails(String name, String surname, String cf){
