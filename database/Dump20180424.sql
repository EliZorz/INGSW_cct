...
--
-- Table structure for table `git_has_tappa`
--

DROP TABLE IF EXISTS `git_has_tappa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `git_has_tappa` (
  `interni_CF` char(16) NOT NULL,
  `gita_NumGita` varchar(8) NOT NULL,
  `is_here` tinyint(4) NOT NULL,
  PRIMARY KEY (`interni_CF`,`gita_NumGita`),
  KEY `fk_gita_has_tappa_gita1_idx` (`gita_NumGita`),
  CONSTRAINT `fk_gita_has_tappa_gita1` FOREIGN KEY (`gita_NumGita`) REFERENCES `gita` (`NumGita`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_gita_has_tappa_interni1` FOREIGN KEY (`interni_CF`) REFERENCES `interni` (`CF`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `git_has_tappa`
--

LOCK TABLES `git_has_tappa` WRITE;
/*!40000 ALTER TABLE `git_has_tappa` DISABLE KEYS */;
/*!40000 ALTER TABLE `git_has_tappa` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `gita_has_tappa` (
  ...
  `is_here` tinyint(4) NOT NULL,
  PRIMARY KEY (`interni_CF`,`gita_NumGita`),
  KEY `fk_interni_has_gita1_gita1_idx` (`gita_NumGita`),
  KEY `fk_interni_has_gita1_interni1_idx` (`interni_CF`),
  CONSTRAINT `fk_interni_has_gita1_gita1` FOREIGN KEY (`gita_NumGita`) REFERENCES `gita` (`NumGita`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2018-04-24 12:17:27
